          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-red-600">
                {notifications[0].timestamp.toLocaleTimeString()} • {notifications.length} active notification{notifications.length !== 1 ? 's' : ''}
              </div>
            </div>
            <button
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        >
          ...
          <div className="absolute top-4 right-4 flex items-center space-x-2">
            <ActivityIndicator isActive={cases.some(c => c.status === 'new')} />
        ...
        >
          ...
          {/* Right Resize Handle */}
          <div
            className="absolute top-0 left-0 w-1 h-full bg-gray-200 hover:bg-blue-400 cursor-col-resize transition-colors"
          ...
          {selectedCase && (
            <div className="absolute top-4 left-4 flex items-center space-x-2">
              <ActivityIndicator isActive={selectedCase.status === 'in-progress'} />
              <span className="text-xs text-gray-500">Patient Data</span>
            </div>
          )}
        </div>
      </div>
